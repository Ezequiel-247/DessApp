...
import { usePlanBreakdown } from "@/features/study-plan/hooks/usePlanBreakdown";
...
export function PlanBreakdown({ planId }: Props) {
              ...
              <CollapsibleContent isOpen={isOpen}>
                <div className="border-t border-slate-100">
                  {section.subjects.length === 0 ? (
                    <p className="p-5 text-body-sm text-on-surface-variant">No hay registros.</p>
                  ) : (
