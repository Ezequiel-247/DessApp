...
interface Props {
  ...
  filterUnahur: boolean;
  onUnahurChange: (checked: boolean) => void;
...
export function SubjectsMobileFilter({
  searchTerm,
  onSearchChange,
  filterUnahur,
  onUnahurChange,
  ...
  const disableAllDropdowns = filterUnahur || filterUnassigned;
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-4">
        <InputToggle
          label="Es UNAHUR"
          checked={filterUnahur}
          onChange={onUnahurChange}
        />
        <InputToggle
          label="No asignadas"
      ...
      <Button variant="secondary" onClick={() => { onReset(); onClose(); }} className="w-full">
