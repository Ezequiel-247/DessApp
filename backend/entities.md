...
Table materials {
  ...
  total_upvotes? int [default: 0] // actualizado automáticamente por hooks en votes
  likes_count? int [default: 0]
  dislikes_count? int [default: 0]
  valoracion_ratio? decimal [default: null] // likes / (likes + dislikes), calculado por hooks
...
Table votes {
  id int [pk, increment]
  target_type varchar [not null] // 'material' o 'post'
  target_id int [not null]
  id_student int [not null, ref: > students.user_id]
  is_upvote bool [not null]
  createdAt timestamp
  updatedAt timestamp
  // Index único: (target_type, target_id, id_student) — un voto por estudiante por contenido
  // Hooks: afterCreate/afterUpdate/afterDestroy ajustan total_upvotes, likes_count, dislikes_count, valoracion_ratio en materials/posts
}

// ==========================================
// INSTANCE SUBJECTS & COURSES (Comisiones / Exámenes)
// ==========================================
...
Table posts {
  ...
  likes_count? int [default: 0]
  dislikes_count? int [default: 0]
  valoracion_ratio? decimal [default: null]
...
Ref: votes.id_student < students.user_id
Ref: votes.target_id > materials.id // cuando target_type = 'material'
Ref: votes.target_id > posts.id // cuando target_type = 'post'

// Instance Subjects & Courses
